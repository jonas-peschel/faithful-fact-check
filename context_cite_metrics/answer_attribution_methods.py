...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, choices=["cnn_daily_mail", "druid", "averitec", "averitec_short_ans", "multifieldqa_en"], default=None, required=True, help="Which dataset to use.")
