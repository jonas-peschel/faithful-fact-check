...
# use deepseek-chat model as compared to full model used in LongCite & SelfCite
parser.add_argument("--gpt_model", type=str, choices=['gpt-4o-mini', 'gpt-4o', 'deepseek-chat'], default='deepseek-chat')
# parallel workers
